...
router.post("/addcart/:dishId/:cartId", isAuth, controller.addtocart);
router.post(
  "/addtoextras/:dishId/:cartId/:id/:extraid",
  isAuth,
  controller.addtoextras
);
router.get("/allcart/:cartId", isAuth, controller.allcartItems);
router.get("/extras/:cartId", controller.allextras);
router.get("/totalcart/:cartId", isAuth, controller.total);
router.delete("/deletecart/:id", isAuth, controller.delete22);
router.post("/checkout", isAuth, controller.checkout);
